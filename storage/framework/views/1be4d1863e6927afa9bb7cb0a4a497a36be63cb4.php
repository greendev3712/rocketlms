                ...
                <div class="card-header">
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_noticeboards_send')): ?>
                        <div class="text-right">
                            <a href="/admin/<?php echo e((!empty($isCourseNotice) and $isCourseNotice) ? 'course-noticeboards' : 'noticeboards'); ?>/send" class="btn btn-primary"><?php echo e(trans('admin/main.send_noticeboard')); ?></a>
                        </div>
                    <?php endif; ?>
                </div>
                                ...
                                <tr>
                                    ...
                                    <td width="100">
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_noticeboards_edit')): ?>
                                            <a href="/admin/<?php echo e((!empty($isCourseNotice) and $isCourseNotice) ? 'course-noticeboards' : 'noticeboards'); ?>/<?php echo e($noticeboard->id); ?>/edit" class="btn-transparent  text-primary" data-toggle="tooltip" data-placement="top" title="<?php echo e(trans('admin/main.edit')); ?>">
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/xs332225/app/dev_rocketlms/resources/views/admin/noticeboards/lists.blade.php ENDPATH**/ ?>