                            ...
                            <?php $__currentLoopData = $support->conversations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $conversations): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="chat-item chat-<?php echo e(!empty($conversations->sender_id) ? 'right' : 'left'); ?>">
                                    ...
                                    <div class="chat-details">
                                        ...
                                        <div class="chat-text"><?php echo $conversations->message; ?></div>
                                        <div class="chat-time">
            ...
            <div class="row">
                <div class="col-12 ">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="/admin/supports/<?php echo e($support->id); ?>/conversation" method="post">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-md-4 text-right mt-4">
                                        ...
                                        <?php if($support->status != 'close'): ?>
                                            <a href="/admin/supports/<?php echo e($support->id); ?>/close" class="btn btn-danger ml-1"><?php echo e(trans('admin/main.close_conversation')); ?></a>
                                        <?php endif; ?>
                                    </div>
                                </div>
                            </form>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\PHP\rocketlms\resources\views/admin/supports/conversation.blade.php ENDPATH**/ ?>