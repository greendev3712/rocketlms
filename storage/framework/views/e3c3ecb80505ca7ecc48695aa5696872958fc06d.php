        ...
        <div class="row">
            ...
            <div class="col-12 col-lg-3 mt-35">
                ...
                <a href="<?php if($authUser->isUser()): ?> /panel/meetings/reservation <?php else: ?> /panel/financial/sales <?php endif; ?>" class="dashboard-stats rounded-sm panel-shadow p-10 p-md-20 d-flex align-items-center mt-15 mt-md-30">
                    ...
                    <div class="d-flex flex-column ml-15">
                        <span class="font-30 text-secondary"><?php echo e(!empty($monthlySalesCount) ? addCurrencyToPrice($monthlySalesCount) : (!empty($reserveMeetingsCount) ? addCurrencyToPrice($reserveMeetingsCount) : 0)); ?></span>
...
<?php echo $__env->make(getTemplate() .'.panel.layouts.panel_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/xs332225/app/dev_rocketlms/resources/views/web/default/panel/dashboard.blade.php ENDPATH**/ ?>