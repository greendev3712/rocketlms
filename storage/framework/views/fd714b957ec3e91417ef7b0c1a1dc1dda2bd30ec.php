        ...
        <div class="section-body card">
            ...
            <div class="row">
                <div class="col-12 col-md-8 col-lg-6">
                        <div class="card-body">
                            <form action="/admin/financial/subscribes/<?php echo e(!empty($subscribe) ? $subscribe->id.'/update' : 'store'); ?>" method="Post">
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/xs332225/app/dev_rocketlms/resources/views/admin/financial/subscribes/new.blade.php ENDPATH**/ ?>