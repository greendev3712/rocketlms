                ...
                <div class="mt-30 row align-items-center">
                    ...
                    <div class="col-12 col-md-7 text-right">
                        <?php if(!empty($course->textLessons) and count($course->textLessons)): ?>
                            ...
                            <a href="<?php echo e((!empty($nextLesson) and !$nextLesson->not_purchased) ? $course->getUrl() .'/lessons/'. $nextLesson->id .'/read' : '#'); ?>" class="btn btn-sm <?php echo e((!empty($nextLesson) and !$nextLesson->not_purchased) ? 'btn-primary' : 'btn-gray disabled'); ?> <?php echo e(($nextLesson->not_purchased) ? 'js-not-purchased' : ''); ?>"><?php echo e(trans('public.next_lesson')); ?></a>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make(getTemplate().'.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/xs332225/app/dev_rocketlms/resources/views/web/default/course/text_lesson.blade.php ENDPATH**/ ?>