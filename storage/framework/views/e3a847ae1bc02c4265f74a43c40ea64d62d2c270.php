    ...
    <div class="position-relative d-flex flex-wrap instructor-finder-card border border-gray300 rounded-sm py-25 mt-20">
        ...
        <div class="col-12 col-md-4 mt-10 mt-md-0 pt-10 pt-md-0 instructor-finder-card-right-side position-relative">
            ...
            <div class="d-flex align-items-start">
                <?php if(!empty($instructor->meeting)): ?>
                    <?php if(!empty($price)): ?>
                        <div class="d-flex flex-column">
                            <span class="font-20 font-weight-bold text-primary"><?php echo e(addCurrencyToPrice(!empty($discount) ? ($price - ($price * $discount / 100)) : $price)); ?></span>

                            <?php if(!empty($discount)): ?>
                                <span class="font-14 font-weight-500 text-gray text-decoration-line-through"><?php echo e(addCurrencyToPrice($price)); ?></span>
                            <?php endif; ?>
                        </div>
...
<?php /**PATH /home/xs332225/app/dev_rocketlms/resources/views/web/default/instructorFinder/components/instructor_card.blade.php ENDPATH**/ ?>