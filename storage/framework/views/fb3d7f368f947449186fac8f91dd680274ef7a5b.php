                                ...
                                <?php if(!empty($selectSupport->conversations) and !$selectSupport->conversations->isEmpty()): ?>
                                    ...
                                    <?php $__currentLoopData = $selectSupport->conversations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $conversations): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="rounded-sm mt-15 border panel-shadow p-15">
                                            ...
                                            <p class="text-gray mt-15 font-weight-500 font-14"><?php echo nl2br($conversations->message); ?></p>
                                        </div>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make(getTemplate() .'.panel.layouts.panel_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\PHP\rocketlms\resources\views/web/default/panel/support/ticket_conversations.blade.php ENDPATH**/ ?>