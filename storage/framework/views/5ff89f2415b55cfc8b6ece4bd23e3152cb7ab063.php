...
<?php $__env->startSection('content'); ?>
    <section class="section">
        ...
        <div class="section-body">
            <section class="card">
                <div class="card-body">
                    <form action="<?php echo e(!empty($region) ? '/admin/regions/'.$region->id.'/update' : '/admin/regions/store'); ?>" method="post">
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\PHP\rocketlms\resources\views/admin/regions/create.blade.php ENDPATH**/ ?>